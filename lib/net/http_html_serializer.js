  ...
  function (contextResponse, request, response) {
    ...
    function renderIndex () {
      ...
      page.push(tag('div', {
          ...
          tag('ul', { 'class': 'types-list' }, (function () {
            ...
            for (key in recordTypes)
              items.push(tag('li', tag('a', {
                ...
                return [
                  tag('span', key in documentation ? {
                    'title': escapeHtml(doc)
                  } : null, escapeHtml(key)),
                  key in documentation ? tag('div', {
        ...
        tag('div', { 'class': 'definition header' }, [
          tag('div', message('Name', language)),
          tag('div', message('Type', language)),
          tag('div', message('Description', language))
        ])
      ].concat(Object.keys(recordTypes).map(function (type) {
        return [
          tag('div', {
            'id': type,
            ...
            tag('div', message('Class', language)),
            tag('div', type in documentation ? {
              'property': 'rdfs:comment'
            } : null, typeof documentation[type] === 'string' ?
              documentation[type] :
              typeof documentation[type] === 'object' ?
              documentation[type][language] ||
              documentation[field][message.defaultLanguage] :
              tag('span', { 'class': 'empty' }, '&mdash;'))
          ]),
          Object.keys(recordTypes[type]).map(function (field) {
            return tag('div', {
              'id': type + '-' + field,
              'class': 'definition',
              'typeof': 'rdfs:Property',
              'resource': prefix + '/#' + type + '-' + field
            }, [
              tag('div', {
                'property': 'rdfs:label'
              }, field),
              tag('div', [
                tag('link', {
                  'property': 'rdfs:range',
                  'typeof': recordTypes[type][field][linkKey] ?
                    '/#' + recordTypes[type][field][linkKey] :
                    xsdMap[recordTypes[type][field][typeKey].name] ||
                    'xsd:simpleType'
                }),
                recordTypes[type][field][linkKey] ||
                  recordTypes[type][field][typeKey].name
              ]),
              tag('div', field in documentation ? {
                'property': 'rdfs:comment'
              } : null, typeof documentation[field] === 'string' ?
                documentation[field] :
